...
!\[title\](README\_resources/images/about/composer.png) !\[title\](README\_resources/images/about/vangogh.png)

\### Step 1\\. Process The following steps are algorithmic representations of artists' creative processes. 1\\. Getting inspiration from some objects or events. 2\\. Draw the entire outline. 3\\. Add and draw details. I thought the generative models I'll be using here have highly similar work flow with the above steps.

!\[title\](README\_resources/images/about/process.png) Similarity between artist's creation process and generative model !\[title\](README\_resources/images/about/generator.png) DCGAN, one of the famous generative models
...
!\[title\](README\_resources/images/about/midiData\_0.png) !\[title\](README\_resources/images/about/midiData\_1.png) !\[title\](README\_resources/images/about/midiData\_2.png) !\[title\](README\_resources/images/about/midiData\_3.png) Real data (target data)
...
\[1) LSTM Architecture image : http://colah.github.io/posts/2015-08-Understanding-LSTMs/ (2018.11.01) \](#img\_lstm)\[2) Tchaikovsky faces : http://witsens.tistory.com/74 (2018.11.01) \](#img\_composer)\[3) Bedroom in Arles : https://pt.wikipedia.org/wiki/Ficheiro:Vincent\_Willem\_van\_Gogh\_135.jpg (2018.11.01) \](#img\_vangogh)\[4) DCGAN Architecture image : https://arxiv.org/abs/1607.07539 \](#img\_dcganModel)
...
!\[title\](README\_resources/images/history/fft\_01wave.png) !\[title\](README\_resources/images/history/fft\_02fft.png) 1) Wave file to Fourier transformation !\[title\](README\_resources/images/history/fft\_03RGB.png) 2) Transformation to 3 dimensional data !\[title\](README\_resources/images/history/fft\_04model.png) 3) Normalization and applying to model !\[title\](README\_resources/images/history/mytarget\_0.png) !\[title\](README\_resources/images/history/mytarget\_1.png) !\[title\](README\_resources/images/history/mytarget\_2.png) !\[title\](README\_resources/images/history/mytarget\_3.png) 4) Above is the target data in AI model

\### Third try - GAN

!\[title\](README\_resources/images/history/gan-model.png) Idea of the GAN !\[title\](README\_resources/images/history/dcgan\_architecture.png) DCGAN architecture - Generator
...
!\[title\](README\_resources/images/history/myResult\_0.png) !\[title\](README\_resources/images/history/myResult\_1.png) !\[title\](README\_resources/images/history/myResult\_2.png) !\[title\](README\_resources/images/history/myResult\_3.png) Generated data of DCGAN (Image)
...
!\[title\](README\_resources/images/history/fft\_reassemble.png) 1) Result : Reassemble !\[title\](README\_resources/images/history/gan\_overfitting.png) 2) Result : Overfitting

\### Reference

\[1) VAE model image : https://lilianweng.github.io/lil-log/2018/08/12/from-autoencoder-to-beta-vae.html (2018.11.01) \](#img\_vaeModel)\[2) GAN model image : https://towardsdatascience.com/understanding-generative-adversarial-networks-4dafc963f2ef (2018.11.01) \](#img\_ganModel)\[3) DCGAN Architecture image : https://arxiv.org/abs/1607.07539 \](#img\_dcganModel)

<% String generateSuccess = (String) request.getAttribute("generateSuccess"); String generatePathRel = (String) request.getAttribute("generatePathRel"); String generatePathAbs = (String) request.getAttribute("generatePathAbs"); if(generateSuccess != null) { if(generateSuccess.equals("True")) { %> !\[generated\](<%out.println(generatePathRel);%>)

 Audio element was not supported.

<% } } else { %> !\[title\](README\_resources/images/title.png) <% }%>

Test model & create data.

Press 'Generate' button for testing model. \[Generate Type A\](generate?type=A) \[Generate Type B\](generate?type=B)
